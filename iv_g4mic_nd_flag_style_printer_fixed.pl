...
% Leibniz substitution: t1 = t2, P(t1) ⊢ P(t2)
fitch_g4_proof(leibniz(G>D), Context, Scope, CurLine, NextLine, ResLine, VarIn, VarOut) :-
    !,
    D = [Goal],
    ...
    !,
    DerLine is CurLine + 1,
    assert_safe_fitch_line(DerLine, Goal, leibniz(EqLine, PredLine), Scope),
